...
// MFCApplicationCal.cpp: define los comportamientos de las clases para la aplicación.
//
...
// CMFCApplicationCalApp

BEGIN_MESSAGE_MAP(CMFCApplicationCalApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMFCApplicationCalApp

CMFCApplicationCalApp::CMFCApplicationCalApp()
{
...
// Único objeto CMFCApplicationCalApp

CMFCApplicationCalApp theApp;


// Inicialización de CMFCApplicationCalApp

BOOL CMFCApplicationCalApp::InitInstance()
{
